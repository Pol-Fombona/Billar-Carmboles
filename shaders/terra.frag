...
vec3 getLight(vec3 color){
    ...
    vec3 diffuse2 = diff2 * light2.Id*0.55;
    vec3 diffuse3 = diff3 * light3.Id*0.55;
    ...
    vec3 specular = spec * light.Is * 0.2;
    vec3 specular2 = spec2 * light2.Is * 0.2;
    vec3 specular3 = spec3 * light3.Is * 0.2;
